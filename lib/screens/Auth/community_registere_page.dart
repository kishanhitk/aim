...
class CommunityRegister extends StatefulWidget {
  ...
  CommunityRegister({this.toggleView});

  @override
  State<StatefulWidget> createState() {
    return _CommunityEmailRegister();
  }
}

class _CommunityEmailRegister extends State<CommunityRegister> {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      FlatButton(
                        child: Text('Sign In as community'),
                        onPressed: () {
                          setState(() {
                            widget.toggleView(2);
                          });
